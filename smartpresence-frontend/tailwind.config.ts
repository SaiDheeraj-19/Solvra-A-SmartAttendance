  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        label: ['12px', { lineHeight: '1.5', letterSpacing: '0.5px', fontWeight: '500' }]
      },
      keyframes: {
        fadeIn: {
        ...
        'pulse-bronze': {
          '0%': { boxShadow: '0 0 0 0 rgba(191,164,122,0.3)' },
          '50%': { boxShadow: '0 0 0 10px rgba(191,164,122,0)' },
          '100%': { boxShadow: '0 0 0 0 rgba(191,164,122,0.3)' }
        },
        spin: {
